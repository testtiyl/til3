...
class NotificationUIUtil: NSObject {
...
//    }
//
//    func showNavigationDropDownView(message: String, height: CGFloat){
//        
////            UITabBarController *tabBarController = (UITabBarController *)[[[UIApplication sharedApplication] delegate] window].rootViewController;
////    
////    UINavigationController *nav = [tabBarController.viewControllers lastObject];
//
//
//
//        let tabBarController:UITabBarController = UIApplication.sharedApplication().delegate!.window.rootViewController
//        
//        
//        let navCon:UINavigationController = tabBarController.selectedViewController
//
//
////        let statusBarHeight = UIApplication.sharedApplication().statusBarFrame.size.height
////        let navigationControllerHeight =  navigationController.navigationBar.frame.size.height
